...
You can also use `cargo-reedme` as a crate. 95% of the `cargo-reedme`’s logic lives in a single, pure function [`cargo_reedme::resolve`](https://docs.rs/cargo-reedme/0.2.0/cargo_reedme/fn.resolve.html)
