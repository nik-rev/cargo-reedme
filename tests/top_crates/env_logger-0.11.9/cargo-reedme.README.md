...
The [`Builder::is_test`](https://docs.rs/env_logger/0.11.9/env_logger/logger/struct.Builder.html#method.is_test) method can be used in unit tests to ensure logs will be captured:
...
environment variable. It accepts the following [fmt::WriteStyle](https://docs.rs/env_logger/0.11.9/env_logger/writer/enum.WriteStyle.html):
...
Color may be applied in the logged message or a [fmt](https://docs.rs/env_logger/0.11.9/env_logger/fmt/).
...
- In the application, calling [Builder::write_style](https://docs.rs/env_logger/0.11.9/env_logger/logger/struct.Builder.html#method.write_style) to have all ANSI escape codes stripped
...
Parts of the default format can be excluded from the log output using the [`Builder`](https://docs.rs/env_logger/0.11.9/env_logger/logger/struct.Builder.html).
...
Custom formats can be provided as closures to the [`Builder`](https://docs.rs/env_logger/0.11.9/env_logger/logger/struct.Builder.html).
These closures take a [crate::fmt::Formatter](https://docs.rs/env_logger/0.11.9/env_logger/fmt/struct.Formatter.html) and `log::Record` as arguments:
...
See the [`fmt`](https://docs.rs/env_logger/0.11.9/env_logger/fmt/) module for more details about custom formats.

## Specifying defaults for environment variables

`env_logger` can read configuration from environment variables.
If these variables aren’t present, the default value to use can be tweaked with the [`Env`](https://docs.rs/env_logger/0.11.9/env_logger/logger/struct.Env.html) type.
