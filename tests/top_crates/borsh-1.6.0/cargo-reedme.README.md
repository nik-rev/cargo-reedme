...
* **std** -
  ...
  To carter such builds, Borsh offers [`io`](https://docs.rs/borsh/1.6.0/borsh/io/) module which includes a items which
  are used in [`BorshSerialize`](https://docs.rs/borsh/1.6.0/borsh/ser/trait.BorshSerialize.html) and [`BorshDeserialize`](https://docs.rs/borsh/1.6.0/borsh/de/trait.BorshDeserialize.html) traits.  Most notably
...
* **derive** -
  Gates derive macros of [BorshSerialize](https://docs.rs/borsh/1.6.0/borsh/ser/trait.BorshSerialize.html) and
  [BorshDeserialize](https://docs.rs/borsh/1.6.0/borsh/de/trait.BorshDeserialize.html) traits.
* **unstable__schema** -
  Gates [BorshSchema] trait and its derive macro.
  Gates [schema] module.
  This feature requires **derive** to be enabled too.
* **rc** -
  Gates implementation of [BorshSerialize](https://docs.rs/borsh/1.6.0/borsh/ser/trait.BorshSerialize.html) and [BorshDeserialize](https://docs.rs/borsh/1.6.0/borsh/de/trait.BorshDeserialize.html)
...
* **ascii** -
  Gates implementation of [BorshSerialize](https://docs.rs/borsh/1.6.0/borsh/ser/trait.BorshSerialize.html), [BorshDeserialize](https://docs.rs/borsh/1.6.0/borsh/de/trait.BorshDeserialize.html), [BorshSchema] for
...
* **de_strict_order** -
  ...
  are encountered in ascending order with respect to [PartialOrd](https://doc.rust-lang.org/stable/core/cmp/trait.PartialOrd.html) for hash collections,
  and [Ord](https://doc.rust-lang.org/stable/core/cmp/trait.Ord.html) for btree ones. Deserialization emits error otherwise.
...
* **hash_collections** -
  ...
  Gates implementation of [BorshSerialize](https://docs.rs/borsh/1.6.0/borsh/ser/trait.BorshSerialize.html), [BorshDeserialize](https://docs.rs/borsh/1.6.0/borsh/de/trait.BorshDeserialize.html)
  and [BorshSchema]
