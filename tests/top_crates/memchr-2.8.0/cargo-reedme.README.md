...
* The top-level module provides routines for searching for 1, 2 or 3 bytes
  ...
  of the bytes.
* The [`memmem`](https://docs.rs/memchr/2.8.0/memchr/memmem/) sub-module provides forward and reverse substring search
  routines.
...
This example shows how to use the [`memmem`](https://docs.rs/memchr/2.8.0/memchr/memmem/) sub-module to find occurrences of
...
subsequent searches. This can be done with a [`memmem::Finder`](https://docs.rs/memchr/2.8.0/memchr/memmem/struct.Finder.html):
...
[`memmem::Finder::into_owned`](https://docs.rs/memchr/2.8.0/memchr/memmem/struct.Finder.html#method.into_owned) API and the
[`arch::all::shiftor`](https://docs.rs/memchr/2.8.0/memchr/arch/all/shiftor/) substring search
