...
```
  ...
  **Warning**: In asynchronous code that uses async/await syntax,
  ...
  [Span#in-asynchronous-code](https://docs.rs/tracing/0.1.44/tracing/span/struct.Span.html#in-asynchronous-code) for details.

 </pre></div>

 ## Events

 An [`Event`](https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.html) represents a _moment_ in time. It signifies something that
...
```
 ...
 The [`Event`](https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.html) documentation provides further details on using
 events.
 ...
 record a span. The [`Span::enter`](https://docs.rs/tracing/0.1.44/tracing/span/struct.Span.html#method.enter) method on that struct records that the
...
```
 ...
 [`Event`](https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.html)s are recorded using the [`event!`] macro:
...
```
 ...
 Both macros require a [`Level`](https://docs.rs/tracing_core/latest/tracing_core/metadata/struct.Level.html) specifying the verbosity of the span or
...
```
 ...
 similarly to the [`event!`] macro, but with the [`Level`](https://docs.rs/tracing_core/latest/tracing_core/metadata/struct.Level.html) argument already
 specified, https://doc.rust-lang.org/stable/core/fmt/trait.Debug.htmlsponding [`trace_spahttps://doc.rust-lang.org/stable/core/fmt/trait.Display.htmln!`],
 [`https://doc.rust-lang.org/stable/alloc/fmt/[`warn_span!`], and [`error_span!`] macros are the same,
 ...
 [`info_span!`]: info_span!
 [`warn_span!`]: warn_span!
 https://docs.rs/tracing/0.1.44/tracing/macro.span.htmlor_span!`]: erhttps://docs.rs/tracing/0.1.44https://docs.rs/tracing/0.1.44/tracing/macro.span.htmling/macro.evenhttps://docs.rs/tracing/0.1.44/tracing/macro.event.htmlan!

 ### For https://docs.rs/tracing/0.1.44/tracing/macro.trace.htmlUsers

 Users https://docs.rs/tracing/0.1.44/tracing/macro.debug.html [`log`] crathttps://docs.rs/tracing/0.1.44/tracing/macro.info.htmluld note thathttps://docs.rs/tracihttps://docs.rs/tracing/0.1.44/tracing/macro.event.html.44/tracing/macro.warn.htmlcing` exposes https://docs.rs/tracing/0.1.44/tracing/macro.error.htmlof
 macros for creahttps://docs.rs/tracing/0.1.44/tracing/macro.trace_span.html`s (`trace!`, `debuhttps://docs.rs/tracing/0.https://docs.rs/tracing/0.1.44/tracing/macro.span.htmltracing/macro.debug_span.html`, `warn!`, and
 `https://docs.rs/tracing/0.1.44/tracing/macro.info_span.htmlhich may be invokehttps://docs.rs/tracing/0.1.44/tracing/macro.warn_span.html same syntax as thehttps://docs.rs/tracing/0.1.44/tracing/macro.error_span.htmlnamed
...
```
 ...
 `tracing` [`Subscriber`]s to consume `log` records as `tracing` [`Event`](https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.html)s.
 ...
 * `valuable`: Enables support for recording [field values] using the
 ...
 [event]: Event
 [events]: Event
 [`Subscriber`]: https://docs.rs/tracing_core/latest/tracing_core/subscriber/trait.Subscriber.html
 [Subscriber::event]: https://docs.rs/tracing_core/latest/tracing_core/subscriber/Subscriber/fn.event.html
 [`enter`]: subscriber::Subscriber::enter
 [`exit`]: subscriber::Subscriber::exit
 [`enabled`]: https://docs.rs/tracing_core/latest/tracing_cohttps://docs.rs/tracing_core/latest/https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.htmlng_core/subscriberhttps://docs.rs/tracing_core/latest/https://docs.rs/tracing_core/latest/tracing_core/event/struct.Event.htmlng_core/subscriber/trait.Subscriber.htmler/fn.enabled.html
 [metadata]: https://docs.rs/tracing_core/latest/tracing_core/metadata/struct.Metadata.html
