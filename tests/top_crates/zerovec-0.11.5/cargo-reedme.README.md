...
- [`ZeroVec<'a, T>`] (and [`ZeroSlice<T>`](https://docs.rs/zerovec/0.11.5/zerovec/zerovec/slice/struct.ZeroSlice.html)) for fixed-width types like `u32`
- [`VarZeroVec<'a, T>`] (and [`VarZeroSlice<T>`](https://docs.rs/zerovec/0.11.5/zerovec/zerovec/slice/struct.ZeroSlice.html)) for variable-width types like `str`
...
This crate has several optional Cargo features:
 ...
 - `derive`: Makes it easier to use custom types in these collections by providing the [`#[make_ule]`](https://docs.rs/zerovec_derive/latest/zerovec_derive/attr.make_ule.html) and
   [`#[make_varule]`](https://docs.rs/zerovec_derive/latest/zerovec_derive/attr.make_varule.html) proc macros, which generate appropriate [`ULE`](https://docs.rs/zerovec/0.11.5/zerovec/ule/trait.ULE.html) and
   [`VarULE`](https://docs.rs/zerovec/0.11.5/zerovec/ule/trait.VarULE.html)-conformant types for a given “normal” type.
