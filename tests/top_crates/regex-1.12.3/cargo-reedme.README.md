...
If you just want API documentation, then skip to the [`Regex`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html) type. Otherwise,
...
The primary type in this crate is a [`Regex`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html). Its most important methods are
as follows:

* [`Regex::new`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.new) compiles a regex using the default configuration. A
[`RegexBuilder`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html) permits setting a non-default configuration. (For example,
case insensitive matching, verbose mode and others.)
* [`Regex::is_match`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.is_match) reports whether a match exists in a particular haystack.
* [`Regex::find`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find) reports the byte offsets of a match in a haystack, if one
exists. [`Regex::find_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find_iter) returns an iterator over all such matches.
* [`Regex::captures`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures) returns a [`Captures`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Captures.html), which reports both the byte
offsets of a match in a haystack and the byte offsets of each matching capture
group from the regex in the haystack.
[`Regex::captures_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures_iter) returns an iterator over all such matches.

There is also a [`RegexSet`](https://docs.rs/regex/1.12.3/regex/regexset/string/struct.RegexSet.html), which permits searching for multiple regex
...
We can also iterate over [`Captures`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Captures.html) values instead of [`Match`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Match.html) values, and
...
One can use [`Captures::extract`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Captures.html#method.extract) to make the code from the previous example a
...
something different. The [`Regex::replace_all`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.replace_all) routine provides a convenient
...
[`Regex::replace`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.replace) for more details.)
...
This demonstrates how to use a [`RegexSet`](https://docs.rs/regex/1.12.3/regex/regexset/string/struct.RegexSet.html) to match multiple (possibly
...
Therefore, only ask for what you need. For example, don’t use [`Regex::find`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find)
if you only need to test if a regex matches a haystack. Use [`Regex::is_match`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.is_match)
instead.
...
(Level 2) from UTS#18.
* The top-level [`Regex`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html) runs searches *as if* iterating over each of the
codepoints in the haystack. That is, the fundamental atom of matching is a
single codepoint.
* [`bytes::Regex`](https://docs.rs/regex/1.12.3/regex/regex/bytes/struct.Regex.html), in contrast, permits disabling Unicode mode for part of all
...
The [`bytes::Regex`](https://docs.rs/regex/1.12.3/regex/regex/bytes/struct.Regex.html) type that can be used to search `&[u8]` haystacks. By
...
top-level [`Regex`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html) on `&str` haystacks, an empty match that splits a codepoint
is guaranteed to never be returned. However, such matches are permitted when
using a [`bytes::Regex`](https://docs.rs/regex/1.12.3/regex/regex/bytes/struct.Regex.html). For example:
...
default. The size limit can be configured via [`RegexBuilder::size_limit`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html#method.size_limit). The
...
at which [`RegexBuilder::size_limit`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html#method.size_limit) is enforced. If the NFA exceeds the
...
something small and expand it as needed. Configure [`RegexBuilder::size_limit`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html#method.size_limit)
...
[`RegexBuilder::size_limit`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html#method.size_limit) exists.
...
complexity bound of `O(m * n)` applies to methods like [`Regex::is_match`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.is_match),
[`Regex::find`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find) and [`Regex::captures`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures). It does **not** apply to
[`Regex::find_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find_iter) or [`Regex::captures_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures_iter). Namely, since iterating over
...
* While routines like [`Regex::find`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find) and [`Regex::captures`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures) guarantee
worst case `O(m * n)` search time, routines like [`Regex::find_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.find_iter) and
[`Regex::captures_iter`](https://docs.rs/regex/1.12.3/regex/regex/string/struct.Regex.html#method.captures_iter) actually have worst case `O(m * n^2)` search time.
...
[`RegexBuilder::size_limit`](https://docs.rs/regex/1.12.3/regex/builders/string/struct.RegexBuilder.html#method.size_limit).
