Securely zero memory with a simple trait ([`Zeroize`](https://docs.rs/zeroize/1.8.2/zeroize/trait.Zeroize.html)) built on stable Rust
...
This crate isn’t about tricks: it uses [`core::ptr::write_volatile`](https://doc.rust-lang.org/stable/core/ptr/fn.write_volatile.html)
and [`core::sync::atomic`](https://doc.rust-lang.org/stable/core/sync/atomic/) memory fences to provide easy-to-use, portable
...
The [`Zeroize`](https://docs.rs/zeroize/1.8.2/zeroize/trait.Zeroize.html) trait is impl’d on all of Rust’s core scalar types including
...
With the `std` feature enabled (which it is **not** by default), [`Zeroize`](https://docs.rs/zeroize/1.8.2/zeroize/trait.Zeroize.html)
...
The [`DefaultIsZeroes`](https://docs.rs/zeroize/1.8.2/zeroize/trait.DefaultIsZeroes.html) marker trait can be impl’d on types which also
impl [`Default`](https://doc.rust-lang.org/stable/core/default/trait.Default.html), which implements [`Zeroize`](https://docs.rs/zeroize/1.8.2/zeroize/trait.Zeroize.html) by overwriting a value with
the default value.
...
Additionally this crate leverages [`core::sync::atomic::compiler_fence`](https://doc.rust-lang.org/stable/core/sync/atomic/fn.compiler_fence.html)
...
- Moves and [`Copy`](https://doc.rust-lang.org/stable/core/marker/trait.Copy.html)
- Heap reallocation when using [`Vec`](https://doc.rust-lang.org/stable/alloc/vec/struct.Vec.html) and [`String`](https://doc.rust-lang.org/stable/alloc/string/struct.String.html)
- Borrowers of a reference making copies of the data

[`core::pin::Pin`](https://doc.rust-lang.org/stable/core/pin/struct.Pin.html) can be leveraged in conjunction with this crate
