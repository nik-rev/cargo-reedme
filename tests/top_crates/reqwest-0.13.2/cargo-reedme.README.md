...
- Plain bodies, [JSON](#json), [urlencoded](#forms), [multipart](https://docs.rs/reqwest/0.13.2/reqwest/async_impl/multipart/)
...
[`reqwest::blocking`](https://docs.rs/reqwest/0.13.2/reqwest/blocking/) API may be more convenient.
...
the [ClientBuilder::cookie_store](https://docs.rs/reqwest/0.13.2/reqwest/async_impl/client/struct.ClientBuilder.html#method.cookie_store) method on `ClientBuilder`.
...
These can be overwritten by adding a [`Proxy`](https://docs.rs/reqwest/0.13.2/reqwest/proxy/struct.Proxy.html) to `ClientBuilder`
...
- Additional server certificates can be configured on a `ClientBuilder`
  with the [`Certificate`](https://docs.rs/reqwest/0.13.2/reqwest/tls/struct.Certificate.html) type.
- Client certificates can be added to a `ClientBuilder` with the
  [`Identity`](https://docs.rs/reqwest/0.13.2/reqwest/tls/struct.Identity.html) type.
- Various parts of TLS can also be configured or even disabled on the
  `ClientBuilder`.

See more details in the [`tls`](https://docs.rs/reqwest/0.13.2/reqwest/tls/) module.
...
: [`tls`](https://docs.rs/reqwest/0.13.2/reqwest/tls/), [`cookie`](https://docs.rs/reqwest/0.13.2/reqwest/cookie/), [`blocking`](https://docs.rs/reqwest/0.13.2/reqwest/blocking/), as well as various `ClientBuilder` methods such as `timeout()` and `connector_layer()`.
...
[serde]: http://serde.rs
[redirect]: https://docs.rs/reqwest/0.13.2/reqwest/redirect/
