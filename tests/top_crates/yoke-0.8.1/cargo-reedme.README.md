...
object (say, a [`Cow<'a, str>`](https://doc.rust-lang.org/stable/alloc/borrow/enum.Cow.html)) to the source it was deserialized from, (say, an [`Rc<[u8]>`](https://doc.rust-lang.org/stable/alloc/rc/struct.Rc.html)),
...
abstraction, potentially with an owned variant (like [`Cow`](https://doc.rust-lang.org/stable/alloc/borrow/enum.Cow.html),
[`ZeroVec`](https://docs.rs/zerovec), or an aggregate containing such types), and the cart `C` will be some smart pointer like
  [`Box<T>`](https://doc.rust-lang.org/stable/alloc/boxed/struct.Box.html), [`Rc<T>`](https://doc.rust-lang.org/stable/alloc/rc/struct.Rc.html), or [`Arc<T>`](https://doc.rust-lang.org/stable/alloc/sync/struct.Arc.html), potentially wrapped in an [`Option<T>`](https://doc.rust-lang.org/stable/core/option/enum.Option.html).
