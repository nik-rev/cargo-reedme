...
You can also check out the [recipes](https://docs.rs/nom/8.0.0/nom/recipes/) module that contains examples of common patterns.
...
check out the [recipes](https://docs.rs/nom/8.0.0/nom/recipes/)!