...
explore neighbors, and apply standard graph algorithms. The [`algo`](https://docs.rs/petgraph/0.8.3/petgraph/algo/) module implements routines such as
shortest‐path searches and minimum spanning trees for any compatible graph, and the [`dot`](https://docs.rs/petgraph/0.8.3/petgraph/dot/) module exports
...
* Finally, each submodule page (e.g., [`algo`](https://docs.rs/petgraph/0.8.3/petgraph/algo/), [`graph`](https://docs.rs/petgraph/0.8.3/petgraph/graph/), [`graphmap`](https://docs.rs/petgraph/0.8.3/petgraph/graphmap/), etc.) provides detailed API documentation and design notes.
...
Generally, algorithms are found in the [`algo`](https://docs.rs/petgraph/0.8.3/petgraph/algo/) module, except for algorithms like
depth-/breadth-first-search, which can be found in the [`visit`](https://docs.rs/petgraph/0.8.3/petgraph/visit/) module. All of them should include
...
visualization and analysis of graphs. The [`dot`](https://docs.rs/petgraph/0.8.3/petgraph/dot/) module provides the necessary functionality to
