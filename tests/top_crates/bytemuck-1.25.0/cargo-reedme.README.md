...
* `T` uses [`cast`](https://docs.rs/bytemuck/1.25.0/bytemuck/fn.cast.html)
* `&T` uses [`cast_ref`](https://docs.rs/bytemuck/1.25.0/bytemuck/fn.cast_ref.html)
* `&mut T` uses [`cast_mut`](https://docs.rs/bytemuck/1.25.0/bytemuck/fn.cast_mut.html)
* `&[T]` uses [`cast_slice`](https://docs.rs/bytemuck/1.25.0/bytemuck/fn.cast_slice.html)
* `&mut [T]` uses [`cast_slice_mut`](https://docs.rs/bytemuck/1.25.0/bytemuck/fn.cast_slice_mut.html)

Depending on the function, the [`NoUninit`](https://docs.rs/bytemuck/1.25.0/bytemuck/no_uninit/trait.NoUninit.html) and/or [`AnyBitPattern`](https://docs.rs/bytemuck/1.25.0/bytemuck/anybitpattern/trait.AnyBitPattern.html) traits
are used to maintain memory safety.

**Historical Note:** When the crate first started the [`Pod`](https://docs.rs/bytemuck/1.25.0/bytemuck/pod/trait.Pod.html) trait was used
...
All the functions listed above are guarded by the [`Pod`](https://docs.rs/bytemuck/1.25.0/bytemuck/pod/trait.Pod.html) trait, which is a
sub-trait of the [`Zeroable`](https://docs.rs/bytemuck/1.25.0/bytemuck/zeroable/trait.Zeroable.html) trait.
...
* `extern_crate_alloc`: Provide utilities for `alloc` related types such as
  Box and Vec.
* `zeroable_maybe_uninit` and `zeroable_atomics`: Provide more [`Zeroable`](https://docs.rs/bytemuck/1.25.0/bytemuck/zeroable/trait.Zeroable.html)
  impls.
* `pod_saturating`: Provide more [`Pod`](https://docs.rs/bytemuck/1.25.0/bytemuck/pod/trait.Pod.html) and [`Zeroable`](https://docs.rs/bytemuck/1.25.0/bytemuck/zeroable/trait.Zeroable.html) impls.
