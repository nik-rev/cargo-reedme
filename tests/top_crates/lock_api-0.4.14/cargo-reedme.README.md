This library provides type-safe and fully-featured [`Mutex`](https://docs.rs/lock_api/0.4.14/lock_api/mutex/struct.Mutex.html) and [`RwLock`](https://docs.rs/lock_api/0.4.14/lock_api/rwlock/struct.RwLock.html)
...
This process is similar for [`RwLock`](https://docs.rs/lock_api/0.4.14/lock_api/rwlock/struct.RwLock.html)s, except that two guards need to be
