...
- **High-level convenience traits**: [`Digest`](https://docs.rs/digest/0.11.0/digest/digest/trait.Digest.html), [`DynDigest`](https://docs.rs/digest/0.11.0/digest/digest/trait.DynDigest.html), [`Mac`].
...
- **Mid-level traits**: [`Update`](https://docs.rs/digest/0.11.0/digest/trait.Update.html), [`FixedOutput`](https://docs.rs/digest/0.11.0/digest/trait.FixedOutput.html), [`FixedOutputReset`](https://docs.rs/digest/0.11.0/digest/trait.FixedOutputReset.html), [`ExtendableOutput`](https://docs.rs/digest/0.11.0/digest/trait.ExtendableOutput.html),
  [`ExtendableOutputReset`](https://docs.rs/digest/0.11.0/digest/trait.ExtendableOutputReset.html), [`XofReader`](https://docs.rs/digest/0.11.0/digest/trait.XofReader.html), [`Reset`](https://docs.rs/crypto_common/latest/crypto_common/trait.Reset.html), [`KeyInit`], and [`InnerInit`].
  These traits atomically describe available functionality of an algorithm.
- **Marker traits**: [`HashMarker`](https://docs.rs/digest/0.11.0/digest/digest/trait.HashMarker.html), [`MacMarker`]. Used to distinguish
