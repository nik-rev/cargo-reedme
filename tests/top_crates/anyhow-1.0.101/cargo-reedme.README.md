...
This library provides [Error](https://docs.rs/anyhow/1.0.101/anyhow/struct.Error.html), a trait object based error
...
- Use `Result<T, anyhow::Error>`, or equivalently `anyhow::Result<T>`, as
  ...
  the [`std::error::Error`](https://doc.rust-lang.org/stable/core/error/trait.Error.html) trait.
